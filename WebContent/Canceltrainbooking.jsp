...
<html>
  <head>
    ...
    <title>VOYAGE MANAGEMENT SYSTEM: TRAIN(Cancel Bookings)</title>
    <style>
           input[type=submit]
                {
            ...
            .bt{
                background-color: rgba(19, 15, 231, 0.493);
                width: 2100px;
                height: 55px;
            }
            .box2{
    ...
    <div class="box2" style="text-align: center; color: white">
      ...
      <form action="Cancelserv">
        <table class="center" style="text-align: center; color: white">
          ...
          <c:forEach items="${TRB}" var="Train" varStatus="status">
            <tr>
            <td>
                <input
                  type="radio"
              ...
              <td><input type="hidden" name="duration" />${Train.duration}</td>
              <td>
        ...
        <input type="submit" value="Cancel" name="canceltrain" />
      </form>
