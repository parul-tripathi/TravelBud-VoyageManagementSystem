...
<html lang="en">
  <head>
    <title>VOYAGE MANAGEMENT SYSTEM: ADD TRAIN TICKET BOOKING DETAILS</title>
    <!-- for-mobile-apps -->
  ...
  <body>
    ...
    <div class="center-container">
      <div class="banner-dott">
        <div class="main">
          <h1 class="w3layouts_head">ADD TRAIN TICKET BOOKING DETAILS</h1>
          <div class="w3layouts_main_grid">
            <form action="../../Confirmtrainserv" class="w3_form_post">
