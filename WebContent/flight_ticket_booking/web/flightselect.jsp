...
<html>
  <head>
    <title>VOYAGE MANAGEMENT SYSTEM: FLIGHT BOOKING</title>
  ...
  <body>
          ...
          <div class="resp-tabs-container">
            <div class="tab-1 resp-tab-content oneway">
              <form action="../../Flightserv" >
                  ...
                  <div class="adults">
                    ...
                    <div class="quantity">
                      <div class="quantity-select">
                        ...
                        <div class="entry value" name="num"><span>1</span></div>
                ...
                <div class="clear"></div>
                <input type="submit" value="Search Flights" name="filter">
              </form>
            </div>
          </div>
        </div>
    ...
    <div class="footer-w3l">
      <p class="agileinfo">TRAVEL BUD<br />VIT,VELLORE</p>
    </div>
