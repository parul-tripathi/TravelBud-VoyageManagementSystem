    ...
    <div class="box2" style="text-align: center; color: white">
      ...
      <form action="Cancelserv">
        <table class="center" style="text-align: center; color: white">
          ...
          <c:forEach items="${PCB}" var="Package" varStatus="status">
            <tr>
            <td>
                <input
                  type="radio"
              ...
              <td><input type="hidden" name="price" />${Package.city}</td>
              <td><input type="hidden" name="price" />${Package.price}</td>
              <td>
                <input type="hidden" name="price" />${Package.duration}
              </td>
              <td>
                <input type="hidden" name="price" />${Package.hotel}
              </td>
              <td><input type="hidden" name="price" />${names[status.index]}</td>
              
              
            </tr>
          </c:forEach>
        </table>
        <input type="submit" value="Cancel" name="cancelpackage" />
      </form>
